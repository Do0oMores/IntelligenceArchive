...
public final class ArchiveRuntimeContext {
    ...
    private final LinkIntelUseCase linkIntelUseCase;
    ...
    ArchiveRuntimeContext(
            ...
            LinkIntelUseCase linkIntelUseCase,
        ...
        this.linkIntelUseCase = Objects.requireNonNull(linkIntelUseCase, "linkIntelUseCase 不能为 null");
    ...
    public LinkIntelUseCase getLinkIntelUseCase() {
        return linkIntelUseCase;
    }
